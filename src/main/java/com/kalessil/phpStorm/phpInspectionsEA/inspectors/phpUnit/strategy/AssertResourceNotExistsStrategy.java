...
public class AssertResourceNotExistsStrategy {
    ...
    static {
        assertionMapping.put("file_exists", "assertFileNotExists");
        assertionMapping.put("is_dir",      "assertDirectoryNotExists");
    }
    ...
    static public boolean apply(@NotNull String function, @NotNull MethodReference reference, @NotNull ProblemsHolder holder) {
        ...
        if (assertionArguments.length > 0 && (function.equals("assertFalse") || function.equals("assertNotTrue"))) {
