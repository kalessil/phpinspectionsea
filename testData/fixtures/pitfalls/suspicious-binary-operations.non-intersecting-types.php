...
abstract class TestCase {
    ...
    public function cases() {
        return [
            ...
            <error descr="'$this->subject() === ''' seems to be always false.">$this->subject() === ''</error>,
            <error descr="'$this->subject() === []' seems to be always false.">$this->subject() === []</error>,
            <error descr="'$this->subject() === null' seems to be always false.">$this->subject() === null</error>,
            ...
            <error descr="'$this->subject() !== ''' seems to be always true.">$this->subject() !== ''</error>,
            <error descr="'$this->subject() !== []' seems to be always true.">$this->subject() !== []</error>,
            <error descr="'$this->subject() !== null' seems to be always true.">$this->subject() !== null</error>,
            $this->subject() != $this->returnsInteger(),
            $this->subject() === $this->annotatedReturnsInteger(),
        ];
    }
