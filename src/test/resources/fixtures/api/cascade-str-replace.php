<?php
    ...
    $str = <warning descr="This str_replace(...) call can be merged with previous one">str_replace</warning> (' ', '-', $str);
    /** dock-block should not break inspection */
    /** multiple dock-blocks should not break inspection */
    $str = <warning descr="This str_replace(...) call can be merged with previous one">str_replace</warning> (' ', '-', $str);
    ...
    $str = str_replace(
        ' ', '-',
        <warning descr="This str_replace(...) call can be merged with parent one">str_replace(' ', '-', $str)</warning>
    );
