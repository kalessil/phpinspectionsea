...
final public class TransitiveDependenciesUsageInspectorTest extends PhpCodeInsightFixtureTestCase {
    public void testIfFindsPatternsWithManifest() {
        ...
        myFixture.configureByFiles(
                ...
                "testData/fixtures/transitiveDependencies/application/vendor/first/subsplit/Clazz.php",
                "testData/fixtures/transitiveDependencies/application/vendor/first/subsplit/composer.json",
