<?php
    ...
    echo date_time_set(new \DateTime(), 0, 0, 0, <error descr="The call will return false ('microseconds' parameter is available in PHP 7.1+).">1</error>);
    echo date_time_set(new \DateTime(), 0, 0, 0, <error descr="The call will return false ('microseconds' parameter is available in PHP 7.1+).">null</error>);
