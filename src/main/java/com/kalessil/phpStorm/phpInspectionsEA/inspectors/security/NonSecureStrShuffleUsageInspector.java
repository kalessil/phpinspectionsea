...
public class NonSecureStrShuffleUsageInspector extends PhpInspection {
    ...
    public String getShortName() {
        return "NonSecureStrShuffleUsageInspection";
    }

    @NotNull
    @Override
    public String getDisplayName() {
        return "Insecure 'str_shuffle(...)' usage (Insufficient Entropy Vulnerability)";
    }
    ...
    public PsiElementVisitor buildVisitor(@NotNull final ProblemsHolder holder, boolean isOnTheFly) {
        return new FeaturedPhpElementVisitor() {
            ...
            public void visitPhpFunctionCall(@NotNull FunctionReference reference) {
                ...
                if (functionName != null && functionName.equals("str_shuffle")) {
