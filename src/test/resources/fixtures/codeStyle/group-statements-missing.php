...
function cases_holder() {
    ...
    <weak_warning descr="Wrap constructs' body within a block (PSR-2 recommendations).">if</weak_warning> ($a) ;
    <weak_warning descr="Wrap constructs' body within a block (PSR-2 recommendations).">elseif</weak_warning> ($b) ;
    else <weak_warning descr="Wrap constructs' body within a block (PSR-2 recommendations).">if</weak_warning> ($c) ;
    else /** doc block */ <weak_warning descr="Wrap constructs' body within a block (PSR-2 recommendations).">if</weak_warning> ($d) ;

    <weak_warning descr="Wrap constructs' body within a block (PSR-2 recommendations).">foreach</weak_warning> ($x as $v) ;
