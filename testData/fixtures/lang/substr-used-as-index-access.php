...
{
    <warning descr="[EA] '( $string[$position] ?? '' )' might be used instead.">substr($string, $position, 1)</warning>;
    <warning descr="[EA] '( $string[strlen($string) - 1] ?? '' )' might be used instead.">substr($string, -1, 1)</warning>;
    <warning descr="[EA] '( $string[strlen($string) - $offset] ?? '' )' might be used instead.">substr($string, -$offset, 1)</warning>;
