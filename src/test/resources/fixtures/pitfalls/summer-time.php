<?php
    ...
    echo <error descr="Consider using \DateTime for DST safe date/time manipulation">$x + 24</error>;
    echo <error descr="Consider using \DateTime for DST safe date/time manipulation">24 + $x</error>;
