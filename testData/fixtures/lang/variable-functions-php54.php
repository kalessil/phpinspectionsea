<?php
    ...
    <weak_warning descr="'forward_static_call($callable, 1, 2, 3)' should be used instead (enables further analysis).">forward_static_call_array ($callable, array(1, 2, 3))</weak_warning>;
    <weak_warning descr="'forward_static_call($callable, 1, 2, 3)' should be used instead (enables further analysis).">forward_static_call_array ($callable, [1, 2, 3])</weak_warning>;
    <weak_warning descr="'forward_static_call($callable, 1, 2, 3)' should be used instead (enables further analysis).">forward_static_call_array ($callable, [0 => 1, 'index' => 2, 3])</weak_warning>;
