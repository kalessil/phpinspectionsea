...
class Clazz
{
    ...
    public function variableFunctionCasesHolder()
    {
        ...
        <error descr="[EA] This call is vulnerable to oracle padding attacks, use OPENSSL_PKCS1_OAEP_PADDING as 4th argument.">$function1('', $encrypted, '')</error>;

        $function2 = '\openssl_public_encrypt';
        <error descr="[EA] This call is vulnerable to oracle padding attacks, use OPENSSL_PKCS1_OAEP_PADDING as 4th argument.">$function2('', $encrypted, '')</error>;
    ...
    public function publicEncryptCasesHolder($optionalParameter = OPENSSL_PKCS1_PADDING)
    {
        ...
        <error descr="[EA] This call is vulnerable to oracle padding attacks, use OPENSSL_PKCS1_OAEP_PADDING as 4th argument.">openssl_public_encrypt('', $encrypted, '', $localVariable)</error>;
    ...
    public function privateDecryptCasesHolder($optionalParameter = OPENSSL_PKCS1_PADDING)
    {
        ...
        <error descr="[EA] This call is vulnerable to oracle padding attacks, use OPENSSL_PKCS1_OAEP_PADDING as 4th argument.">openssl_private_decrypt('', $encrypted, '', $localVariable)</error>;
