<?php
    ...
    $x = <weak_warning descr="[EA] '$object->property !== null' construction should be used instead.">isset($object->property)</weak_warning>;
    $y = <weak_warning descr="[EA] '$object->property === null' construction should be used instead.">!isset($object->property)</weak_warning>;
