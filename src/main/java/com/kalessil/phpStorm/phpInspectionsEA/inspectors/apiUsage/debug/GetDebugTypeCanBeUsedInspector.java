...
public class GetDebugTypeCanBeUsedInspector extends PhpInspection {
    ...
    public PsiElementVisitor buildVisitor(@NotNull final ProblemsHolder holder, final boolean isOnTheFly) {
        return new FeaturedPhpElementVisitor() {
            ...
            public void visitPhpTernaryExpression(@NotNull TernaryExpression ternary) {
                if (this.shouldSkipAnalysis(ternary, StrictnessCategory.STRICTNESS_CATEGORY_LANGUAGE_LEVEL_MIGRATION)) { return; }
                ...
                if (! ternary.isShort()) {
                    ...
                    if (OpenapiTypesUtil.isFunctionReference(condition)) {
                        ...
                        if (functionName != null && functionName.equals("is_object")) {
                            final boolean isAvailable = FunctionsPolyfillsIndexer.isFunctionAvailable("\\get_debug_type", holder.getProject());
                            if (isAvailable) {
