<?php
    ...
    <weak_warning descr="[EA] 'Namespace\Clazz::method($a)' would make more sense here (it also faster).">call_user_func('Namespace\\Clazz::method', $a)</weak_warning>;
    <weak_warning descr="[EA] 'Namespace\Clazz::method($a)' would make more sense here (it also faster).">forward_static_call('Namespace\\Clazz::method', $a)</weak_warning>;
