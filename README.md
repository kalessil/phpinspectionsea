...
| Code style           | PrefixedIncDecrementEquivalentInspection        | Prefixed increment/decrement equivalent             | no |
...
| Architecture         | BadExceptionsProcessingInspection               | Badly organized exception handling                  | no |
| Architecture         | MoreThanThreeArgumentsInspection                | More than 3 parameters in callable                  | no |
