...
public class DynamicInvocationViaScopeResolutionInspectorTest extends CodeInsightFixtureTestCase {
    public void testIfFindsAllPatterns() {
        myFixture.configureByFile("fixtures/dynamic-method-incocation-via-scope-resolution.php");
