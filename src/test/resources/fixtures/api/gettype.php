<?php
    ...
    $x = <warning descr="'is_bool($x)' construction would be more compact and easier to read">gettype($x) === 'boolean'</warning>;
    $x = <warning descr="'is_int($x)' construction would be more compact and easier to read">gettype($x) === 'integer'</warning>;
    $x = <warning descr="'is_float($x)' construction would be more compact and easier to read">gettype($x) === 'double'</warning>;
    $x = <warning descr="'is_string($x)' construction would be more compact and easier to read">gettype($x) === 'string'</warning>;
    $x = <warning descr="'is_array($x)' construction would be more compact and easier to read">gettype($x) === 'array'</warning>;
    $x = <warning descr="'is_object($x)' construction would be more compact and easier to read">gettype($x) === 'object'</warning>;
    $x = <warning descr="'is_resource($x)' construction would be more compact and easier to read">gettype($x) === 'resource'</warning>;
    $x = <warning descr="'is_null($x)' construction would be more compact and easier to read">gettype($x) === 'NULL'</warning>;
