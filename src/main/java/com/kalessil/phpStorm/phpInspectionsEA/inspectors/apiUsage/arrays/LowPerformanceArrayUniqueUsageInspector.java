...
public class LowPerformanceArrayUniqueUsageInspector extends BasePhpInspection {
    private static final String strProblemUseArrayKeysWithCountValues = "array_keys(array_count_values(...)) would be more efficient.";
    private static final String strProblemUseCountWithCountValues     = "count(array_count_values(...)) would be more efficient.";
