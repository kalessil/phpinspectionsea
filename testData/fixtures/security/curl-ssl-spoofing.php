...
class OpensslRsaPaddingOracle
{
    ...
    public function optionsCasesHolder($ch)
    {
        ...
        <error descr="Exposes a connection to MITM attacks. Use 2 (default) to stay safe.">$options[CURLOPT_SSL_VERIFYHOST] = 0</error>;
        <error descr="Exposes a connection to MITM attacks. Use true (default) to stay safe.">$options[CURLOPT_SSL_VERIFYPEER] = 0</error>;
    }
}