...
namespace {
    ...
    class <weak_warning descr="[EA] Class has 3 parent classes, consider using appropriate design patterns.">Level4Class</weak_warning>
                      extends Level3Class {}
}
...
namespace PHPUnit\Framework {
    ...
    class <weak_warning descr="[EA] Class has 3 parent classes, consider using appropriate design patterns.">IDoTestingWrong</weak_warning>
...
namespace yii\base {
    ...
    class <weak_warning descr="[EA] Class has 3 parent classes, consider using appropriate design patterns.">IDoOopWrong</weak_warning>
