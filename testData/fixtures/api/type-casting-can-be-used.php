...
function cases_holder() {
    ...
    $x = <weak_warning descr="[EA] Casting to int or float would be more performant here (up to 6x times faster).">$x * 1</weak_warning>;
    $x = <weak_warning descr="[EA] Casting to int or float would be more performant here (up to 6x times faster).">1 * $x</weak_warning>;
